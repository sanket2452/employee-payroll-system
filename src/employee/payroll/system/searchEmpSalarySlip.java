...
PreparedStatement pst=null;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql ="select * from Deductions2 where emp_id = '"+value1+"'";
     ...
     if(rs.next()){
           ...
           myDocument.add(new Paragraph("Total Deductions : $"+(calcTotal-total) ,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
